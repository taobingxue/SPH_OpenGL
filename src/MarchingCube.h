...
public:
	...
	MarchingCube(const double _bound[], double _l, list<Particle> *_particles):
		...
		mapping(sum_e) {
			...
			//printf("p0: %lf, %lf, %lf\n", ((particles->front()).getPosition())[0], ((particles->front()).getPosition())[1], ((particles->front()).getPosition())[2]);
			//printf("pn: %lf, %lf, %lf\n", ((particles->back()).getPosition())[0], ((particles->back()).getPosition())[1], ((particles->back()).getPosition())[2]);
	}
	~MarchingCube() {
